...
def render_html(
    ...
    general_problems = [problem for problem in problem_values if problem_key(problem) < 0]
    problem_values = [problem_value for problem_value in problem_values if problem_value not in general_problems]
